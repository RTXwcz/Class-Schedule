...
package com.kebiao.app.ocr.paddle.model

import android.content.Context
import com.kebiao.app.ocr.paddle.util.YamlUtils
import java.io.File
...
data class ModelConfig(
    ...
    companion object {
        fun parse(context: Context, assetPath: String): ModelConfig {
            val content = try {
                require(File(assetPath).isAbsolute) { "OCR dictionary requires a private file path" }
